...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <div className="border-primary-base/30 bg-background-base/80 dark:border-primary-base-dark/10 dark:bg-background-base-dark/80 rounded-lg border p-6 backdrop-blur-xs">
