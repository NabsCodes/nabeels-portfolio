      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group border-primary-base/10 bg-background-base/80 hover:border-primary-base/30 dark:border-primary-base-dark/10 dark:bg-background-base-dark/80 relative overflow-hidden rounded-lg border backdrop-blur-xs transition-all"
          >
          ...
          <motion.div
            ...
            className="border-primary-base/10 bg-background-base/80 hover:border-primary-base/30 dark:border-primary-base-dark/10 dark:bg-background-base-dark/80 overflow-hidden rounded-lg border backdrop-blur-xs transition-all"
          >
            <div className="p-6">
              <div className="flex items-center gap-4">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-4">
          <motion.div
            ...
            viewport={{ once: true }}
            className="border-primary-base/10 bg-background-base/80 dark:border-primary-base-dark/10 dark:bg-background-base-dark/80 rounded-lg border p-4 text-center backdrop-blur-xs"
          >
