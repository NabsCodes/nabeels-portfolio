        ...
        >
          {skillsContent.groups.map((group) => (
            <motion.div
              ...
              className="border-primary-base/30 bg-background-base/50 dark:border-primary-base-dark/10 dark:bg-background-base-dark/50 relative h-full rounded-xl border p-6"
            >
              {/* Decorative gradient */}
              ...
              <div className="grid auto-rows-fr grid-cols-2 gap-3 sm:grid-cols-2 md:grid-cols-2">
                {group.skills.map((skill) => (
                  <motion.div
                    key={skill.name}
                    className="group border-primary-base/20 bg-background-base/80 hover:border-primary-base/30 dark:border-primary-base-dark/10 dark:bg-background-base-dark/80 dark:hover:border-primary-base-dark/30 flex flex-col items-center justify-center gap-2 rounded-lg border p-3 backdrop-blur-xs transition-all hover:shadow-xs"
                    whileHover={{ y: -2 }}
