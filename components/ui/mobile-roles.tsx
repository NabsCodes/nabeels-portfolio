    ...
    <div className="space-y-3">
      {heroContent.roles.map((item, index) => (
        <motion.div
          ...
          className="group border-primary-base/20 bg-background-base/80 hover:border-accent-base/50 dark:border-primary-base-dark/20 dark:bg-background-base-dark/50 dark:hover:border-accent-base-dark/50 relative overflow-hidden rounded-lg border backdrop-blur-xs transition-all duration-300"
        >
  ...
  >
    <div className="flex flex-wrap gap-3">
      {heroContent.roles.map((item, index) => (
        ...
        >
          <div className="from-primary-base via-accent-base to-primary-base dark:from-primary-base-dark dark:via-accent-base-dark dark:to-primary-base-dark absolute -inset-1 rounded-lg bg-linear-to-r opacity-0 blur-sm transition duration-300 group-hover:opacity-50" />
          <div className="border-primary-base bg-background-base/90 dark:border-primary-base-dark/30 dark:bg-background-base-dark/90 relative flex items-center gap-2 rounded-lg border px-4 py-2 backdrop-blur-xs transition-colors">
            <item.icon className="text-primary-base group-hover:text-accent-base dark:text-primary-base-dark dark:group-hover:text-accent-base-dark h-4 w-4 transition-colors" />
            <span className="font-space-grotesk text-primary-base-dark group-hover:text-accent-base dark:text-primary-base-dark dark:group-hover:text-accent-base-dark text-sm transition-colors">
              {item.label}
            </span>
...
const MobileRolesSidebar = () => (
  <motion.div
    ...
    className="mb-8 lg:hidden"
  >
    <div className="border-primary-base/30 bg-background-base/80 dark:border-primary-base-dark/20 dark:bg-background-base-dark/50 relative rounded-lg border p-4 backdrop-blur-xs">
...
const MobileRolesGrid = () => (
  <motion.div
    ...
    className="mb-8 lg:hidden"
  >
    <div className="border-primary-base/20 bg-background-base/80 dark:border-primary-base-dark/20 dark:bg-background-base-dark/50 overflow-hidden rounded-lg border backdrop-blur-xs">
...
const MobileRolesCode = () => (
  <motion.div
    ...
    className="mb-8 lg:hidden"
  >
    <div className="border-primary-base bg-background-base/60 dark:border-primary-base-dark/30 dark:bg-background-base-dark/50 overflow-hidden rounded-lg border backdrop-blur-xs">
  ...
  >
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
      {heroContent.roles.map((item, index) => (
        ...
        >
          {/* Gradient Glow */}
          <div className="from-primary-base to-accent-base dark:from-primary-base-dark dark:to-accent-base-dark absolute -inset-0.5 rounded-lg bg-linear-to-r opacity-0 blur-sm transition duration-300 group-hover:opacity-30" />

          {/* Card Content */}
          <div className="border-primary-base/20 bg-background-base/80 hover:border-accent-base/50 dark:border-primary-base-dark/20 dark:bg-background-base-dark/50 dark:hover:border-accent-base-dark/50 relative flex items-center gap-3 rounded-lg border p-3 shadow-lg backdrop-blur-xs transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
        {heroContent.roles.map((item, index) => (
          <motion.button
            ...
            className="group from-background-base to-background-base hover:from-primary-base hover:to-accent-base dark:from-background-base-dark dark:to-background-base-dark dark:hover:from-primary-base-dark dark:hover:to-accent-base-dark relative rounded-lg bg-linear-to-r p-[1px] transition-all duration-300"
          >
            <div className="bg-background-base/80 dark:bg-background-base-dark/80 relative flex items-center gap-2 rounded-lg p-3 backdrop-blur-xs">
              <item.icon className="text-primary-base group-hover:text-accent-base dark:text-primary-base-dark dark:group-hover:text-accent-base-dark h-4 w-4 transition-colors" />
              <span className="font-space-grotesk text-primary-base-dark group-hover:text-accent-base dark:text-primary-base-dark dark:group-hover:text-accent-base-dark text-sm transition-colors">
                {item.label}
              </span>
...
const MobileRolesMinimal = () => (
  <motion.div
    ...
    className="mb-8 lg:hidden"
  >
    <div className="border-primary-base/20 bg-background-base/60 dark:border-primary-base-dark/20 dark:bg-background-base-dark/40 overflow-hidden rounded-lg border backdrop-blur-xs">
      {/* Top Bar */}
