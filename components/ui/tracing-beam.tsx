    ...
    >
      <div className="absolute top-3 -left-4 hidden md:-left-20 md:block">
        <motion.div
          ...
          className="border-primary-base/20 bg-background-base dark:border-primary-base-dark/20 dark:bg-background-base-dark ml-[27px] flex h-4 w-4 items-center justify-center rounded-full border shadow-xs backdrop-blur-xs"
        >
          <motion.div
            transition={{
              duration: 0.2,
